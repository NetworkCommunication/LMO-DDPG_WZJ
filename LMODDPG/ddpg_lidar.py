        ...
        if flag !=1:
            ...
            while True:
                try:
                    ...
                    y = str(y)
                    t=str(t)
                    f1=open('save_memory/'+agent_name + '/ddpg_lidar_x.csv',mode='a')
                    f1.write(x + '\n')
                    f1.close()

                    f2 = open('save_memory/' +agent_name+ '/ddpg_lidar_y.csv', mode='a')
                    f2.write(y + '\n')
                    f2.close()


                    f3 = open('save_memory/' +agent_name+ '/ddpg_lidar_t.csv', mode='a')
                    f3.write(t + '\n')
                    f3.close()
                    ...
                    f2 = open('save_memory/'+agent_name + '/ddpg_lidar_p.csv', mode='a')
                    f2.write(p + '\n')
                    f2.close()

                    f3 = open('save_memory/'+agent_name + '/ddpg_lidar_c.csv', mode='a')
                    f3.write(c + '\n')
                    f3.close()


                    v = str(arrv)
                    f6 = open('save_memory/'+agent_name + '/ddpg_lidar_v.csv', mode='a')
                    f6.write(v + '\n')
                    f6.close()
                    arrv.clear()

                    position = str(arrp)
                    f7 = open('save_memory/'+agent_name + '/ddpg_lidar_position.csv', mode='a')
                    f7.write(position + '\n')
                    f7.close()
                    arrp.clear()
